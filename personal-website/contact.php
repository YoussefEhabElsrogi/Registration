        ...
        <div class="bg-light rounded-4 py-5 px-4 px-md-5">
          ...
          <div class="row gx-5 justify-content-center">
            <div class="col-lg-8 col-xl-6">
              ...
              <!-- to get an API token!-->
              <form action="./handelrs/handelContact.php" method="POST" id="contactForm"
                data-sb-form-api-token="API_TOKEN">
                <?php if (issetSession('success')): ?>
                  <div class="alert alert-success text-center display-7 " role="alert">
                ...
                <?php if (issetSession('errors')): ?>
                  <?php foreach ($_SESSION['errors'] as $error): ?>
                    <div class="alert alert-danger text-center display-7 " role="alert">
                      <?php echo $error; ?>
                    </div>
                    <?php removeSession('errors'); endforeach; ?>
                <?php endif; ?>
                <!-- Name input-->
